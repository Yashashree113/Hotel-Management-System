...
export class AdminLoginComponent implements OnInit {
  ...
  login(){
    ...
    if(this.passwordMissing === false && this.emailIdWrong === false && this.emailIdMissing === false){
      ...
      console.log(bodyem)
      this.httpC.post<any>('http://localhost:8080/admin/admin/login',bodyem).subscribe((x) => {
        switch(x.message){
  ...
  signup(){
    ...
    if(this.passwordMissing === false && this.emailIdWrong === false && this.emailIdMissing === false){
      ...
      console.log(bodyem)
      this.httpC.post<any>('http://localhost:8080/admin/admin/signup',bodyem).subscribe((x) => {
        switch(x.message){
